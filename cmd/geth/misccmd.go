...
import (
	...
	"github.com/ethereum/go-ethereum/contracts/contractgo"
	...
	algorandcore "github.com/ethereum/go-ethereum/consensus/algorand/core"
...
func makeMinerKey(ctx *cli.Context) error {
	...
	config := params.EthereumMainnetChainConfig.Algorand
	if ctx.GlobalBool(utils.TestnetFlag.Name) {
		config = params.EthereumTestnetChainConfig.Algorand
...
func dumpVote(ctx *cli.Context) error {
	...
	recoverFile := fmt.Sprintf("%s/ethereum/msg/%d", dataDir, height)
